...
export function Target({ size = 24, color = '#3B82F6' }: IconProps) {
    return (
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
            <Circle cx="12" cy="12" r="10" stroke={color} strokeWidth="1.5" />
...
export function ChartBar({ size = 24, color = '#3B82F6' }: IconProps) {
    return (
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function FileText({ size = 24, color = '#3B82F6' }: IconProps) {
    return (
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function Pen({ size = 24, color = '#FF0000' }: IconProps) {
    return (
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
            ...
            <Circle cx="11" cy="11" r="2" stroke={color} strokeWidth="1.5" />
        </Svg>
    );
}

export function Eraser({ size = 24, color = '#71717A' }: IconProps) {
    return (
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
            <Path d="M20 20H7L3 16C2.4 15.4 2.4 14.6 3 14L14 3C14.6 2.4 15.4 2.4 16 3L21 8C21.6 8.6 21.6 9.4 21 10L11 20" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <Path d="M18 7L8 17" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </Svg>
    );
}

export function Highlighter({ size = 24, color = '#FBBF24' }: IconProps) {
    return (
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
            <Path d="M9 11L12 2L15 11L12 14L9 11Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <Path d="M12 14L12 22" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
            <Path d="M9 22H15" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
        </Svg>
    );
}

export function Trash({ size = 24, color = '#EF4444' }: IconProps) {
    return (
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function Flag({ size = 24, color = '#FBBF24' }: IconProps) {
    return (
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function ArrowLeft({ size = 24, color = '#fafafa' }: IconProps) {
    return (
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function ArrowRight({ size = 24, color = '#fafafa' }: IconProps) {
    return (
        <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
